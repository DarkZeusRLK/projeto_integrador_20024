...
$query = "SELECT * FROM hoteis_aracaju WHERE id_hotel = ?";
...
<head>
  ...
  <style>
    ...
    #container {
      display: block;
      /* Garante que o contêiner principal empilhe elementos */
      margin: 0 auto;
    ...
    #card-info {
      ...
      margin: 20px auto;
      /* Centraliza o card com margem superior e inferior */
      padding: 20px;
      /* Adiciona espaçamento interno */
      text-align: center;
      /* Centraliza o texto */
      background-color: #f9f9f9;
      /* Adiciona um fundo claro */
      border-radius: 8px;
    ...
    .gallery-images {
      display: block;
      /* Garante que as imagens fiquem empilhadas */
    }

    .gallery-images img {
      width: 100%;
      /* Cada imagem ocupa toda a largura do contêiner */
      height: auto;
      border-radius: 8px;
    ...
    #faq {
      ...
      max-width: 700px;
      margin: 20px auto;
      /* Centraliza as seções com margem superior e inferior */
      padding: 20px;
      /* Adiciona algum espaçamento interno */
    }
    ...
    .carousel {
      ...
      overflow: hidden;
      /* Oculta imagens que saem do contêiner */
    }
    ...
    .carousel-images img {
      width: 100%;
      /* Cada imagem ocupa toda a largura do carrossel */
      display: none;
    ...
    .carousel-button {
      ...
      padding: 10px;
      z-index: 1000;
      /* Coloca o botão acima do carrossel */
    }
...
<body>
  ...
  <div id="container">
    ...
    <div id="card-info">
      ...
      <p>Valor: <?php echo $pacote['valor_diaria']; ?> </p>
    </div>
    <!-- Galeria de Imagens -->
    <div id="gallery">
    ...
    <section id="details">
      ...
      <ul>
        ...
        <strong>Comodidades:</strong> Academia, Piscina, Restaurante</li>
