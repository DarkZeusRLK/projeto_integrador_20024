        ...
        <div class="container">
            <div id="form-container-ctt" class="form-container">
                ...
                <div class="payment--options">
                    <a class="botoes d-flex justify-content-center align-items-center" href="user/boleto.php">
                        <center>
                            <svg class="d-flex justify-content-center align-items-center" xml:space="preserve" viewBox="0 0 124 33" height="33px" width="124px" y="0px" x="0px" id="Layer_1" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a class="botoes" name="google" href="user/">
                        <center>
                            <svg fill="none" viewBox="0 0 80 39" height="39" width="80" xmlns="https://logopng.com.br/logos/pix-106.svg">
                    ...
                    <a class="botoes" href="user/pix.php">
                        <center>
